...
public class Device {
    ...
    private BigDecimal dDeciceLatitude;//地图位置（纬度）
    ...
    private int iDeviceType;//设备类型：0：默认设备 1：LoRa集中器 2：CoAP/NB-IoT 3 ：LoRa模块 4：网络io 5：二维码添加 6：LoRaWAN 7.电信 CoAP/NB-IoT 8:PLC云网关
    ...
    @Basic
    @Column(name = "dDeciceLatitude")
    public BigDecimal getdDeciceLatitude() {
        return dDeciceLatitude;
    }

    public void setdDeciceLatitude(BigDecimal dDeciceLatitude) {
        this.dDeciceLatitude = dDeciceLatitude;
    }
    ...
    *//** 中间表*//*
    ...
    public boolean equals(Object o) {
        ...
        return id == device.id &&
                iDeviceStatus == device.iDeviceStatus &&
                iDeviceType == device.iDeviceType &&
                Objects.equals(company, device.company) &&
                Objects.equals(sDeviceName, device.sDeviceName) &&
                Objects.equals(sDeviceId, device.sDeviceId) &&
                Objects.equals(deviceGroup, device.deviceGroup) &&
                Objects.equals(sDevicePass, device.sDevicePass) &&
                Objects.equals(sHardver, device.sHardver) &&
                Objects.equals(sSoftver, device.sSoftver) &&
                Objects.equals(sImg, device.sImg) &&
                Objects.equals(sLength, device.sLength) &&
                Objects.equals(sCustomFields, device.sCustomFields) &&
                Objects.equals(dDeviceLongitude, device.dDeviceLongitude) &&
                Objects.equals(dDeciceLatitude, device.dDeciceLatitude) &&
                Objects.equals(sDeviceAddress, device.sDeviceAddress) &&
                Objects.equals(sSn, device.sSn) &&
                Objects.equals(iProtocol, device.iProtocol) &&
                Objects.equals(iPollingInterval, device.iPollingInterval) &&
                Objects.equals(deviceSlaves, device.deviceSlaves) &&
                Objects.equals(sQRcode, device.sQRcode) &&
                Objects.equals(dCreateTime, device.dCreateTime) &&
                Objects.equals(dUpdateTime, device.dUpdateTime);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, company, sDeviceName, sDeviceId, deviceGroup, iDeviceStatus, sDevicePass, sHardver, sSoftver, sImg, sLength, sCustomFields, dDeviceLongitude, dDeciceLatitude, sDeviceAddress, sSn, iProtocol, iPollingInterval, iDeviceType, deviceSlaves, sQRcode, dCreateTime, dUpdateTime);
    }
    ...
    public String toString() {
        return "Device{" +
                ...
                ", dDeciceLatitude=" + dDeciceLatitude +
